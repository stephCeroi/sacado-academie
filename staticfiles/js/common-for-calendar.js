requirejs.config({
    ...
    paths: {
        ...
        datepicker000: ["https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.0/js/bootstrap-datepicker.min", "lib/bootstrap-datepicker"],
        ...
        moment: "../schedule/js/moment.min",
        fullcalendar: "../schedule/fullcalendar/fullcalendar",
        admin: "lib/app.min",
...
require(['jquery', 'bootstrap', 'mathjax', 'ui', 'ckeditor', 'ckeditor_init', 'ckeditor_jquery',  'datatables', 'datatables_bootstrap',
    'config_select2', 'datepicker','config_datepicker',  'config_toggle', 'config_colorpicker', 'fonctions_jquery', 'fonctions' ,  'ui_sortable', 
    'multiselect', 'slimscroll', 'chart', 'moment', 'fullcalendar',   ]);
