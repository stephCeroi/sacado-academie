        ...
        Multiselect.prototype = {
            ...
            events: function() {
                ...
                self.$right.closest('form').on('submit', function(e) {
                    ...
                    self.$right.find('option').prop('selected', self.options.submitAllRight);  // A enlever pour enregistrer la partie gauche ?
                });
                ...
                self.actions.$moveUp.on('click', function(e) {
                    ...
                    var $options = self.$left.find(':selected:not(span):not(.hidden)');
